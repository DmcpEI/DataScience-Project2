...
# data_modeling1.analyze_knn(results["manhattan"]["model"], results["manhattan"]["params"],results["manhattan"]["metric"], trnX, trnY, tstX, tstY)
#
# results, trnX, trnY, tstX, tstY = data_modeling2.evaluate_knn()
