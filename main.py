...
data_processing1.apply_best_outliers_approach_classification('Truncate', techniques1,
...
data_processing1.apply_best_scaling_approach_classification('Standard', techniques1,
...
data_processing1.apply_best_balancing_approach_classification('SMOTE', techniques1, smote_X1, smote_y1)
